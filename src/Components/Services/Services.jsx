...
const Services = () => {
  return (
    <div className="px-4  sm:space-x-4 sm:space-y-0 lg:flex lg:px-16 xl:px-32 lg:justify-center lg:items-center">
      ...
      <div className="space-y-4 md:flex md:space-y-0 md:space-x-4 pt-10 ">
        {services.map((data) => (
          <div className=" flex flex-col  justify-center items-center  space-y-6 py-6 px-8 rounded-3xl border-[1px] lg:flex-wrap hover:scale-105 transition-all duration-300  cursor-pointer lg:py-16">
