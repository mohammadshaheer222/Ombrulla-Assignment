    ...
    <div className="px-4 py-10 lg:px-28">
      ...
      <img src={feature} alt="feature-image" className="lg:order-2 lg:w-[40%]" />
        <div className="lg:order-1 lg:w-1/2 space-y-4">
          <h3 className="text-2xl uppercase text-[#F85E9F] mt-10 tracking-widest font-bold text-center lg:text-left">
            Key Features
          </h3>
          <h1 className="text-4xl font-bold tracking-wider text-center lg:text-left">
